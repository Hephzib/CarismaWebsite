...
<html lang="en">
   ...
   <body>
      ...
      <!-- why us area start -->
     <form class="row g-3" method="post" action="mail.php" id="candidate-form">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" required id="firstname" placeholder="First Name" name="name">
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                       ...
                                       <input type="file" class="form-control-file" id="datauristring">
                                    </div>
                                    ...
                                    <div class="col-4 text-right">
                                       <button class="button btn-primary mr0" type="submit" name="submit" >Submit</button>
