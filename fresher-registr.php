...
<div id="Paris" class="careertabcontent">
               <!-- <span onclick="this.parentElement.style.display='none'" class="topright">&times</span>    --> 
                    <form role="form" name="sendmail" action="sql_ormanage.php" onSubmit="return checkBeforeSubmit()" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                             <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="namenow" name="firstname" placeholder="" >
                                </div>
                            </div>
                          </div>
                          <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="namenow" name="mobile" placeholder="" >
                                </div>
                            </div>
                          </div>
                        ...
                        <div class="row">     
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="qualification" id="qualification" class="form-control locat-require text-prop" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="course" id="course" class="form-control locat-require text-prop" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="yearpassed" id="yearpassed" class="form-control locat-require text-prop" >
                                      <option value="">Select</option>
                                      <?php
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="state" id="currentstate" class="form-control locat-require text-prop" >
                                      <option value="">Select</option>
                                      <?php
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="referred" id="referredby" class="form-control locat-require text-prop" >
                                      <option value="">Select</option>
                                      <?php
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="filesresume[]" accept=".doc,.docx,.pdf" id="resume" >
                              </div>
                            </div>
                        </div>  
                        <div class="row">
