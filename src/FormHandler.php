 ...
 *  	
 *  ==== Sample usage ====
 *   FormHandler::create()->validate(function($validator)
 *   		{
...
class FormHandler
{
	...
	public function __construct()
	{
		...
		$this->mailer->Subject = "Candidate Details Submission - Name: ". $_POST['name'].", Years of Experience: ". $_POST['Years'].", Applying For: ". $_POST['Applying'].", Location: Chennai";
