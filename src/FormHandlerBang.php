 ...
 *  	
 *  ==== Sample usage ====
 *   $fh = FormHandlerBang::create()->validate(function($validator)
 *   		{
...
class FormHandlerBang
{
	...
	public function __construct()
	{
		...
		$this->mailer->Subject = "Contact Form Submission - Name: ". $_POST['name'].", Years of Experience: ". $_POST['Years']. ", Applying For: Junior Accountant". ", Location: Bangalore";
		//$this->mailer->Subject = "Name:venkat, Exp: 2, Location: Chennai ". $_POST['name'];
	    ...
	    $this->mailer->setFrom($from_email,'Candidate details',false);  
