...
class FormHandlerCpa
{
	...
	public function __construct()
	{
		...
		$this->mailer->Subject = "New request for trail ";

		//Using Aamazon AWS SES SMTP account
 $this->mailer->IsSMTP();
$this->mailer->SMTPDebug =  2;
 $this->mailer->SMTPAuth   = true;
 $this->mailer->SMTPSecure = "TLS or STARTTLS";
 $this->mailer->Host       = "smtp.office365.com";
 $this->mailer->Port       = 587; 
 $this->mailer->Username   = "connectwork@carismasolutions.com.au";
$this->mailer->Password   = "Indian@1234";
