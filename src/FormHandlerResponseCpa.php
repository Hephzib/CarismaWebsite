...
class FormHandlerResponseCpa
{
	...
	public function __construct()
	{
		...
		// $this->mailer->Host       = 'smtpout.asia.secureserver.net';                     //Set the SMTP server to send through
		// $this->mailer->SMTPAuth   = true;                                   //Enable SMTP authentication
		// $this->mailer->Username   = 'gobim@stephenventures.com';                     //SMTP username
		// $this->mailer->Password   = 'vasantha@123';                               //SMTP password
        ...
        //$host_email ='forms@'.$host;
        //$to = "pooja.r@purplequay.com"
        $from_email = $_SESSION["emailid"];
        //$message = $_POST['comment'];
   		//$this->mailer->setFrom($from_email,'Contact Form',false);
	    $this->mailer->setFrom($from_email,'Carisma Solutions',false);  
		//$this->mailer->AddReplyTo($from_email,"Pooja");
     
        // $this->mailer->addAddress($from_email,'Carisma Solutions');
        // $this->mailer->Subject = "Test Mail from carisma solutions";
        // $this->mailer->Body = "<h2><b>".$name." ".$email."</b></h2>";
	...
	{
		return new FormHandlerResponseCpa();
	}
	...
	public function process($post_data)
	{
		...
		// 	// $this->mailer = new PHPMailer;
		// 	// $this->mail_template='';
		// 	$this->autoRespond = new PHPMailer();
		// 	$host_email ='forms@'.$host;
	
		// 	$this->autoRespond->setFrom($host_email,'Contact Form',false);
		// 	//$autoRespond->setFrom('office@myhost.co.uk', 'Alex');
		// 	$this->autoRespond->AddAddress($from_email); 
		// 	$this->autoRespond->Subject = "Autorepsonse: We received your submission"; 
		// 	$this->autoRespond->Body = "We received your submission. We will contact you";
			
		// 	$this->autoRespond->Send(); 
		// 	}
